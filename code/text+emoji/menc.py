...
for train_index,test_index in kf.split(total_sequence,label_enc):
    ...
    input_text_shared1= Dense(100, activation="relu")(input_text_shared)
    ...
    model=Model(inputs=[input_glove,input_bert,input_sbert,input_use,input_emoji],outputs=[stance_output,emo_output,toxic_output])
    ...
    model.fit([train_sequence,train_sequence,train_sequence_sbert,train_sequence_use,emoji_train_sequence],[train_stance,train_emo,train_toxic], shuffle=True,validation_split=0.2,epochs=20,verbose=2)
    predicted = model.predict([test_sequence,test_sequence,test_sequence_sbert,test_sequence_use,emoji_test_sequence])
    print(predicted)
    print(predicted)
