...
total_sequence= np.load("../../embedding_matrix/sentence_embed.npy")
...
with open('model/sbert_stance_emo_toxic_final.json', 'w') as json_file:
    json_file.write(model_architecture)


model.save_weights('model/sbert_stance_emo_toxic_final_weights.h5')
